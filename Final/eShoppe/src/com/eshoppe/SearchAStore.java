...
public class SearchAStore extends Activity implements OnMarkerClickListener{
	...
	private static String TAG = SearchAStore.class.toString();
...
//			AIzaSyBPwwCIYG94ejZB0i_mJrjU3r_MHNWLRhs
			String url = "https://maps.googleapis.com/maps/api/place/textsearch/json?key=AIzaSyBPwwCIYG94ejZB0i_mJrjU3r_MHNWLRhs&query="+params[0];
